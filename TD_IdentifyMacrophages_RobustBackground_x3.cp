...
ApplyThreshold:[module_num:12|svn_version:\'6746\'|variable_revision_number:5|show_window:False|notes:\x5B\x5D]
    ...
    Minimize the weighted variance or the entropy?:Weighted variance
    Assign pixels in the middle intensity class to the foreground or the background?:Foreground
    Select the measurement to threshold with:Threshold_FinalThreshold_Cells_Green
...
ConserveMemory:[module_num:17|svn_version:\'9401\'|variable_revision_number:1|show_window:False|notes:\x5B\x5D]
...
FilterObjects:[module_num:19|svn_version:\'10300\'|variable_revision_number:5|show_window:False|notes:\x5B\x5D]
...
RelateObjects:[module_num:20|svn_version:\'10300\'|variable_revision_number:2|show_window:False|notes:\x5B\x5D]
...
RescaleIntensity:[module_num:22|svn_version:\'6746\'|variable_revision_number:2|show_window:False|notes:\x5B\'Rescales 4096 to 65536 grey values for export (x16)\'\x5D]
    Select the input image:DAPI
...
RescaleIntensity:[module_num:23|svn_version:\'6746\'|variable_revision_number:2|show_window:False|notes:\x5B\'Rescales 4096 to 65536 grey values for export (x16)\'\x5D]
    Select the input image:FITC
...
GrayToColor:[module_num:25|svn_version:\'10341\'|variable_revision_number:2|show_window:False|notes:\x5B\x5D]
...
OverlayOutlines:[module_num:26|svn_version:\'10672\'|variable_revision_number:2|show_window:False|notes:\x5B\x5D]
...
ExportToSpreadsheet:[module_num:29|svn_version:\'10880\'|variable_revision_number:7|show_window:False|notes:\x5B"Export any measurements to a comma-delimited file (.csv). The measurements made for the nuclei, cell and cytoplasm objects will be saved to separate .csv files, in addition to the per-image .csv\'s."\x5D]
