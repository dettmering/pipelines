...
LoadImages:[module_num:1|svn_version:\'11587\'|variable_revision_number:11|show_window:True|notes:\x5B\'Load the images by matching files in the folder against the unique text pattern for each stain\x3A d0.tif for nuclei, d1.tif for the PH3 image, d2.tif for the cell stain image. The three images together comprise an image set.\'\x5D]
    ...
    Image count:2
    Text that these images have in common (case-sensitive):02.tif
    ...
    Text that these images have in common (case-sensitive):00.tif
...
MeasureObjectIntensity:[module_num:4|svn_version:\'10816\'|variable_revision_number:3|show_window:True|notes:\x5B\'Measure intensity features from nuclei, cell and cytoplasm objects against the cropped images.\'\x5D]
    Hidden:2
...
MeasureObjectSizeShape:[module_num:5|svn_version:\'1\'|variable_revision_number:1|show_window:True|notes:\x5B\'Measure morphological features from the cell, nuclei and cytoplasm objects.\'\x5D]
    Select objects to measure:Nuclei
    Select objects to measure:Cells
