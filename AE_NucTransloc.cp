...
LoadImages:[module_num:1|svn_version:\'11587\'|variable_revision_number:11|show_window:True|notes:\x5B"Load the images by matching files in the folder against the unique text pattern for each stain\x3A \'Channel 1\' for protein, \'Channel 2\' for the nuclei image. The two images together comprise an image set."\x5D]
...
IdentifySecondaryObjects:[module_num:3|svn_version:\'10826\'|variable_revision_number:7|show_window:True|notes:\x5B\'Identify the cells by using the nuclei as a "seed" region, then growing outwards until stopped by the image threshold or by a neighbor. The Distance-B method is used to delineate the boundary between neighboring cells.\'\x5D]
...
MeasureObjectIntensity:[module_num:5|svn_version:\'10816\'|variable_revision_number:3|show_window:True|notes:\x5B\'Measure intensity features from nuclei, cell and cytoplasm objects against the corrected images.\'\x5D]
    Hidden:1
...
CalculateMath:[module_num:6|svn_version:\'10905\'|variable_revision_number:1|show_window:True|notes:\x5B\'Calculate the nuclei-to-cell ratio of the mean protein intensity.\'\x5D]
...
CalculateMath:[module_num:7|svn_version:\'10905\'|variable_revision_number:1|show_window:True|notes:\x5B\'Calculate the cytoplasm-to-cell ratio of the mean protein intensity.\'\x5D]
...
OverlayOutlines:[module_num:8|svn_version:\'10672\'|variable_revision_number:2|show_window:True|notes:\x5B\'Overlay the nucleus and cell outlines on the protein image.\'\x5D]
...
SaveImages:[module_num:9|svn_version:\'10822\'|variable_revision_number:7|show_window:True|notes:\x5B"Save the nuclei overlay image as an 8-bit TIF, appending the text \'_Outlined\' to the original filename of the protein image."\x5D]
...
ExportToSpreadsheet:[module_num:10|svn_version:\'10880\'|variable_revision_number:7|show_window:True|notes:\x5B"Export any measurements to a comma-delimited file (.csv). The measurements made for the nuclei, cell and cytoplasm objects will be saved to separate .csv files, in addition to the per-image .csv\'s."\x5D]
