...
ApplyThreshold:[module_num:13|svn_version:\'6746\'|variable_revision_number:5|show_window:False|notes:\x5B\x5D]
    Select the input image:CorrRed
...
CalculateMath:[module_num:14|svn_version:\'10905\'|variable_revision_number:1|show_window:True|notes:\x5B\x5D]
    Name the output measurement:MathGreen
    Operation:Add
    Select the first operand measurement type:Image
    Select the first operand objects:None
    Select the first operand measurement:Threshold_FinalThreshold_ThreshGreen
    Multiply the above operand by:0.125
    ...
    Select the second operand measurement:Threshold_FinalThreshold_ThreshGreen
    Multiply the above operand by:0.5
    Raise the power of above operand by:1
...
CalculateMath:[module_num:15|svn_version:\'10905\'|variable_revision_number:1|show_window:True|notes:\x5B\x5D]
    Name the output measurement:MathRed
    Operation:Add
    Select the first operand measurement type:Image
    Select the first operand objects:None
    Select the first operand measurement:Threshold_FinalThreshold_ThreshRed
    Multiply the above operand by:0.125
    Raise the power of above operand by:1
    Select the second operand measurement type:Image
    Select the second operand objects:None
    Select the second operand measurement:Threshold_FinalThreshold_ThreshRed
    Multiply the above operand by:0.5
    Raise the power of above operand by:1
    Take log10 of result?:No
    Multiply the result by:1
...
ConserveMemory:[module_num:16|svn_version:\'9401\'|variable_revision_number:1|show_window:False|notes:\x5B\x5D]
    ...
    Select image to remove:ThreshGreen
    Select image to remove:ThreshRed

ApplyThreshold:[module_num:17|svn_version:\'6746\'|variable_revision_number:5|show_window:True|notes:\x5B\x5D]
    Select the input image:CorrGreen
    Name the output image:ThreshGreenFinal
    Select the output image type:Grayscale
    Set pixels below or above the threshold to zero?:Below threshold
    Subtract the threshold value from the remaining pixel intensities?:No
    Number of pixels by which to expand the thresholding around those excluded bright pixels:0.0
...
ApplyThreshold:[module_num:18|svn_version:\'6746\'|variable_revision_number:5|show_window:True|notes:\x5B\x5D]
    ...
    Minimize the weighted variance or the entropy?:Weighted variance
    Assign pixels in the middle intensity class to the foreground or the background?:Foreground
    Select the measurement to threshold with:Math_MathRed

MeasureObjectSizeShape:[module_num:19|svn_version:\'1\'|variable_revision_number:1|show_window:False|notes:\x5B\x5D]
...
FilterObjects:[module_num:22|svn_version:\'10300\'|variable_revision_number:5|show_window:False|notes:\x5B\x5D]
    ...
    Select the measurement to filter by:Intensity_MeanIntensity_ThreshGreenFinal
...
FilterObjects:[module_num:23|svn_version:\'10300\'|variable_revision_number:5|show_window:False|notes:\x5B\x5D]
    ...
    Measurement count:2
    Additional object count:0
    Select the measurement to filter by:Intensity_MeanIntensity_ThreshRedFinal
    Filter using a minimum measurement value?:Yes
    Minimum value:0.0001
    Filter using a maximum measurement value?:No
    Maximum value:1
...
RelateObjects:[module_num:24|svn_version:\'10300\'|variable_revision_number:2|show_window:False|notes:\x5B\x5D]
...
RescaleIntensity:[module_num:28|svn_version:\'6746\'|variable_revision_number:2|show_window:False|notes:\x5B\'Rescales 4096 to 65536 grey values for export (x16)\'\x5D]
    Select the input image:PI
...
GrayToColor:[module_num:29|svn_version:\'10341\'|variable_revision_number:2|show_window:False|notes:\x5B\x5D]
